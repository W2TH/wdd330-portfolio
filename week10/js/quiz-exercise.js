...
function shuffle(array) {
    console.log('shuffle(array) invoked');
...
const game = {
    start(quiz) {
        ...
        element.classList.add("progressBarCountdown");
    },
    countdown() {
    ...
    ask(name) {
        ...
        if (this.questions.length > 2) {
            ...
            console.log(`The answer is ${this.question.realName}`);
        } else {
            this.gameOver();
        }
    },
    ...
    gameOver() {
        ...
        var element = document.getElementById("progressBar");
        element.classList.remove("progressBarCountdown");
    },
    hiScore() {
